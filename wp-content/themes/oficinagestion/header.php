...
-->
    ...
    <!-- Global site tag (gtag.js) - Google Analytics --> <script async src="https://www.googletagmanager.com/gtag/js?id=G-Q8PNYN4JGC"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-Q8PNYN4JGC'); </script>
    ...
    <header id="unalTop">
      ...
      <span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span>
        ...
        <div id="bs-navbar" class="navbar-collapse collapse navigation">
            <div class="site-url">
                <a href="https://ogabogota.unal.edu.co/">ogabogota.unal.edu.co</a>
            </div>
            <div class="buscador">
            ...
            <div class="btn-group hidden hidden-sm hidden-md hidden-lg hidden-print">
