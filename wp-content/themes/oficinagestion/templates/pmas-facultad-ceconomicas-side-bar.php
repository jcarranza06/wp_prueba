<?php
  /*
    Template Name: PMAS Fac Ciencias Economicas
  */
	get_header();
...
<main class="detalle">
	...
	<div class="content row sidebar-row">
		...
		<div id="sidebar-right" class="sidebar">
			<?php if ( is_active_sidebar( 'pmas-facultad-ceconomicas-side-bar' ) ) : ?>
		    	<?php dynamic_sidebar( 'pmas-facultad-ceconomicas-side-bar' ); ?>
			<?php endif; ?>
		</div>
	</div>
	<?php 
