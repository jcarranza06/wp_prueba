<?php
  /*
    Template Name: Aspectos e impactos ambientales
  */
	get_header();
...
<main class="detalle">
	...
	<div class="content row sidebar-row">
		...
		<div id="sidebar-right" class="sidebar">
			<?php if ( is_active_sidebar( 'aspectos-e-impactos-ambientales-side-bar' ) ) : ?>
		    	<?php dynamic_sidebar( 'aspectos-e-impactos-ambientales-side-bar' ); ?>
			<?php endif; ?>
		</div>
	</div>
	<?php 
