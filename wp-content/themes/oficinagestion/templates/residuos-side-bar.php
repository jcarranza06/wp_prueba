...
<main class="detalle">
	...
	<div class="head">
		<div class="backimg">
            ...
            "https://ogabogota.unal.edu.co/wp-content/uploads/2023/02/foto4_general-1-scaled.jpg",
			"https://ogabogota.unal.edu.co/wp-content/uploads/2023/02/foto5_general-1-scaled.jpg"),10000);?>
		</div>
	</div>
	...
	<div class="content row sidebar-row">
		...
		<div id="sidebar-right" class="sidebar">
			<?php if ( is_active_sidebar( 'residuos-side-bar' ) ) : ?>
		    	<?php dynamic_sidebar( 'residuos-side-bar' ); ?>
			<?php endif; ?>
		</div>
	</div>
	<?php 
