<?php
  /*
    Template Name: Residuos de Construccion y demolicion
  */
	get_header();
...
<main class="detalle">
	...
	<div class="head">
		...
		<div class="backimg">
            ...
            "https://ogabogota.unal.edu.co/wp-content/uploads/2022/12/ciencias-1-scaled.jpg",
            "https://ogabogota.unal.edu.co/wp-content/uploads/2022/12/genetica-min-1-scaled.jpg",
            "https://ogabogota.unal.edu.co/wp-content/uploads/2022/12/museo-de-arte-1-scaled.jpg"),10000);?>
		</div>
	</div>
	...
	<div class="content row sidebar-row">
		...
		<div id="sidebar-right" class="sidebar">
			<?php if ( is_active_sidebar( 'residuos-de-construccion-y-demolicion-side-bar' ) ) : ?>
		    	<?php dynamic_sidebar( 'residuos-de-construccion-y-demolicion-side-bar' ); ?>
			<?php endif; ?>
		</div>
	</div>
	<?php 
